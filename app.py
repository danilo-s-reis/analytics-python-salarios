...
df = pd.read_csv("https://raw.githubusercontent.com/danilo-s-reis/datasets/refs/heads/main/salarios_dados.csv")
...
if not df_filtrado.empty:
    ...
    grafico_ano = px.line(
        ...
        y='usd',
        markers=True,
        title='Evolução do salário médio anual (USD) ao longo dos anos',
    ...
    grafico_ano.update_layout(
        ...
        xaxis = dict(
            tickmode = 'linear',
            dtick = 1  # Força o intervalo a ser de 1 em 1 unidade (ano inteiro)
        ),
    )
